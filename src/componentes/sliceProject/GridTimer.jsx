...
function GridTimer({ country, arrayCountry , nextPrayerName , nextPrayerTime }) {
  return (
    <Grid2 container style={{ display: "flex", justifyContent: "space-around", alignItems: "center", width: "100%", padding: "20px", color:"white", textShadow: "3px 2px BLACK" }}>
        <Grid2 item xs={6} style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column", gap: "20px", marginBottom: "20px" }}>
          <div style={{
            display: "flex",
            alignItems: "center",
